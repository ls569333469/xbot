  ...
  for (const group of groupActivityMatches(activity, whitelists)) {
    ...
    const signal = await signalQueries.createSignal({
        ...
        chain_id: group.whitelist.chain_id,
         symbol: group.whitelist.symbol,
         project_name: group.whitelist.project_name,
         project_x_handles: group.whitelist.project_x_handles,
         budget_per_trade: group.whitelist.budget_per_trade,
         total_budget: group.whitelist.total_budget,
         slippage: group.whitelist.slippage,
         allow_repeat_buy: group.whitelist.allow_repeat_buy,
         max_repeat_buys: group.whitelist.max_repeat_buys,
         exit_strategy: group.whitelist.exit_strategy,
         exit_strategy_version: group.whitelist.exit_strategy_version,
         auto_tp_pct: group.whitelist.auto_tp_pct,
         auto_sl_pct: group.whitelist.auto_sl_pct,
         trade_config_snapshot_source: 'fixed_ca_signal',
